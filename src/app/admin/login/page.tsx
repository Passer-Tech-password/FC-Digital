      ...
      <div className="flex-1 flex items-center justify-center p-8 relative">
        ...
        <div className="w-full max-w-md">
          ...
          <button
            ...
            className="w-full py-4 px-6 bg-card-800 border border-border-100 rounded-xl flex items-center justify-center gap-3 hover:bg-card-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {googleLoading ? (
          ...
          <div className="mt-8 text-center">
            ...
            <Link href="/contact" className="text-primary-500 hover:text-primary-400 font-medium">Contact Administrator</Link>
          </div>
        </div>
      </div>
    </div>
