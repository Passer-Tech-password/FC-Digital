        ...
        <div className="flex items-center gap-4">
          <div className="relative hidden sm:block">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 rounded-xl bg-card-700 border border-border-100 text-sm text-white placeholder-text-tertiary focus:outline-none focus:border-primary-500 transition-all"
            />
          </div>
          ...
          <CardContent>
            <div className="space-y-3">
              {[
                ...
                <div key={idx} className="flex items-center justify-between p-3 bg-card-700/50 rounded-xl border border-border-100">
                  <div className="flex items-center gap-3">
          ...
          <CardContent>
            <div className="space-y-3">
              {[
                ...
                <div key={idx} className="flex items-start gap-3 p-3 bg-card-700/50 rounded-xl border border-border-100">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary-500 to-primary-300 flex items-center justify-center text-xs font-bold">
                    {msg.avatar}
                  </div>
